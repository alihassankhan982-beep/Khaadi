const Footer = () => {
  return (
    <div className="font-sans">
      {/* Footer Info Bar */}
      <div className="bg-[#fdf6f0] border-t border-b border-[#ede8e2] grid grid-cols-1 md:grid-cols-3 px-6 md:px-12 py-5">
        <div className="flex items-center gap-4 px-6 py-2 border-b md:border-b-0 md:border-r border-[#e5ddd5] first:pl-0 last:border-r-0">
          <div className="w-[50px] height-[50px] border-[1.5px] border-dashed border-[#d4a89a] rounded-full flex items-center justify-center shrink-0 p-3">
            <svg
              viewBox="0 0 24 24"
              className="w-[22px] h-[22px] stroke-[#c9745f] fill-none stroke-[1.5] stroke-round"
            >
        ...
        <div className="flex items-center gap-4 px-6 py-2 border-b md:border-b-0 md:border-r border-[#e5ddd5] last:border-r-0">
          <div className="w-[50px] height-[50px] border-[1.5px] border-dashed border-[#d4a89a] rounded-full flex items-center justify-center shrink-0 p-3">
            <svg
              viewBox="0 0 24 24"
              className="w-[22px] h-[22px] stroke-[#c9745f] fill-none stroke-[1.5] stroke-round"
        ...
        <div className="flex items-center gap-4 px-6 py-2 last:border-r-0">
          <div className="w-[50px] height-[50px] border-[1.5px] border-dashed border-[#d4a89a] rounded-full flex items-center justify-center shrink-0 p-3">
            <svg
              viewBox="0 0 24 24"
              className="w-[22px] h-[22px] stroke-[#c9745f] fill-none stroke-[1.5] stroke-round"
      ...
      <div className="bg-white px-6 md:px-12 py-[22px] flex items-center gap-110 border-b border-[#ede8e2]">
        ...
        <div className="bg-white px-6 md:px-12 py-[22px]">
          ...
          >
            {/* Custom FAQ Document Icon */}
            <svg
              viewBox="0 0 24 24"
              className="w-9 h-9 fill-none stroke-black stroke-[1.2]"
              strokeLinecap="round"
      ...
      <hr className="border-none border-t border-[#ede8e2] m-0" />

      {/* Main Footer Links */}
      <div className="bg-white px-6 md:px-12 pt-12 pb-9 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="footer-col">
          ...
          <div className="flex items-center border-b border-[#1a1a1a] pb-[6px] gap-2">
            <input
              ...
              className="flex-1 border-none outline-none text-[14px] text-[#888] bg-transparent py-1"
            />
            <button
              type="button"
              className="bg-[#1a1a1a] text-white border-none rounded-[20px] px-[18px] py-2 text-[11px] font-bold tracking-[0.12em] uppercase cursor-pointer whitespace-nowrap hover:opacity-75 transition-opacity duration-[0.16s]"
            >
              Confirm
            </button>
          </div>
      ...
      {/* Footer Bottom */}
      <div className="bg-white px-6 md:px-12 py-[22px] grid grid-cols-1 md:grid-cols-3 items-center gap-6 border-t border-[#ede8e2]">
        ...
        <div className="flex flex-col gap-1 items-center md:items-start">
          ...
          <div className="inline-flex items-center gap-2 border-[1.5px] border-[#5ba73f] rounded-[4px] px-[14px] py-[7px] text-[11px] text-[#5ba73f] font-bold tracking-[0.04em]">
            <svg
              viewBox="0 0 24 24"
              className="w-[18px] h-[18px] stroke-[#5ba73f] fill-none stroke-2 stroke-round"
            >
        ...
        <div className="flex items-center gap-[30px]">
          <div className="flex items-center gap-[6px]">
            <img className="w-[50.58px]" src="./src/assets/logo.png" alt="" />
          </div>
